...
cl = LINETCR.LINE()
cl.login(token='ErEDUBGAEPhleTBeBSo2.cgM2mbGybJNV6ZLunKEEaG.ZIP6GvDC/wVMO7MKRFaa/9GZBpXEyHH0Fcf5r8BgOSU=')
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token='ErXPlbjSCfti2cZtSrj1.GGQgfQP7oMPQBTGwA5OiOq.TpZ0XCxDvxwZxF3chFcRENws2mXMxrYfqBdgc/HjzeI=')
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token='ErtK8xQH88kZgETi08k7.DlqRyKJ45By6qR51/9HR5W.AZ/hAH0iQKoe97k2Rd176NZAboP3KqTck3GEJ6ffkvQ=')
kk.loginResult()

ks = LINETCR.LINE()
ks.login(token='Erz4iafHin1LiPTbGxqb.0cO2i9McKyZSokcFO8Tp/W.xZh6p8EbGB8fXp6Dq+z4dpBSIZ+tpag26DERQ3xyowM=')
ks.loginResult()
...
admin = ["u0869b63018180639efeb395436479e02","u1044b4a5ea7baa68c17ac39b29e94346"]
...
Rx3 = ["u74b42b6248f8e5b63a42be75fbd86be7"]
Rx2 = ["ud02a3623d982918cec38a09fa3cb4ffb"]
Rx1 = ["uc7367ca7a712c7dd1793cf179766afbf"]
...
wait = {
    ...
    "lang":"JP",
    "comment":"💫Auto like 💗Love💗  http://line.me/ti/p/gyegyegyew  ",
    "likeOn":False,
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
...
#----------------------------------------------------------
            elif msg.text in ["Beph","respon","responsename"]:
                ki.sendText(msg.to,"Iya Sayang")
                kk.sendText(msg.to,"Hadir")
                ks.sendText(msg.to,"Ada")		
#----------------------------------------------------------
