...
cl = LINETCR.LINE()
cl.login(token='Es8A4pygKaiXPjjX0pu2.kNzAW5yp4/7QBbUrxJ7JSG.tcwS3tY/48OBKkDsiEWJtAO5rYpRa0biVHMAs9FdTec=')
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token='Er9AbJRvjgKsIlhBUmL6.YGt476BWTizfUfkE6l1t9G.hURr90sYzGScEpaiYDWMAhuJ4Pd/xeohzsp7UIMZkGg=')
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token='Er8Pu9PtEBLP6cglcQLf.YBCAMnLWbGP/3xkPIZAHdW.LgQmiMjI02und68bpSkssv7LcKhJcKNVW5GMNbYMbJ0=')
kk.loginResult()

ks = LINETCR.LINE()
ks.login(token='Er7RuAvmvuWXkWbnk8j1.hcj9sxaRwlwOuJpWfCWgmq.fMo3FBEyLIj31bs/u3D0VyNF3RPtEpApyJGWUhV2vaI=')
ks.loginResult()

print "login success"
reload(sys)
sys.setdefaultencoding('utf-8')
helpMessage ="""By.GheVha.Selfbot
...
admin = ["u2a765ac3960fe3eeea6c1b915e3ee3b2"]
...
admins =["u2a765ac3960fe3eeea6c1b915e3ee3b2"]
Rx3 = ["u225c0ccad06fd9311e0bb5d3466337f8"]
Rx2 = ["u6eb039efe17f69980878d56960cbfe06"]
Rx1 = ["u34f7b775cd5b593a06e4848db2200683"]
Administrator = admins + Rx3 + Rx2 + Rx1
AS = Rx2 + Rx1 + Rx3
adminsA = admins + Rx3+Rx2+Rx1
...
wait = {
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"💫Haiii\nThanks Sudah Add Salam Kenalll\n🇲🇨GyeVha🇲🇨",
    "lang":"JP",
    "comment":"💫Auto like 💗Love💗  http://line.me/ti/p/~gyevha1_  ",
    "likeOn":False,
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u0869b63018180639efeb395436479e02":
                    if "join:" in msg.text:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                if wait["commentOn"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"🔄 Auto Comentar Di Aktifkan")
                else:
                    wait["commentOn"] = True
                    if wait["lang"] == "JP":
                ...
                if wait["commentOn"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Commentar Dimatikan")
                else:
...
#--------------------------------------------------------
                ...
                cl.sendText(msg.to,"🔥Team Both 🔥")
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'u2a765ac3960fe3eeea6c1b915e3ee3b2'}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"🔥CREATOR GYEVHA 🔥\n 🔥CREATOR AISYA 🔥")
...
#-----------------------------------------------------------                          
                ...
                if msg.contentMetadata is not None:
                    ...
                    for target in targets:
                        ...
                        pass
            elif "Gye1 Ratakan" in msg.text:
				OWN = "u0869b63018180639efeb395436479e02"
				if msg.from_ in OWN:
					pass
				else:
						...
						for target in targets:
							try:
								if msg.from_ not in target:
									...
									ki.kickoutFromGroup(msg.to, [target])							   
									pass
            elif "Gye2 Ratakan" in msg.text:
				OWN = "u85cdb72bc0141fd9473ef2df11281260"
				if msg.from_ in OWN:
					pass
				else:
            ...
            elif "Gye3 Ratakan" in msg.text:
				OWN = "ubc741ff5270938ce41d391d9c931e7af"
				if msg.from_ in OWN:
					pass
				else:
...
#----------------------------------------------------------
            elif msg.text in ["Cek","respon","responsename"]:
                ki.sendText(msg.to,"🔥Team Both 1 🔥")
                kk.sendText(msg.to,"🔥Team Both 2 🔥")
                ks.sendText(msg.to,"🔥Team Both 3 🔥")		
#----------------------------------------------------------
